...
const ProductSwiper = () => {
  return (
    ...
    >
      <SwiperSlide>   <img className="w-100" src={require(`../../Asset/images/promo1.png`).default}/></SwiperSlide>
      <SwiperSlide>   <img className="w-100" src={require(`../../Asset/images/promo2.png`).default}/></SwiperSlide>
      <SwiperSlide>   <img className="w-100" src={require(`../../Asset/images/promo3.png`).default}/></SwiperSlide>
